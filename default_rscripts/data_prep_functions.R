...
data_prep <- function(visId){
  data_dir <- file.path(getwd(),"instance", "store",visId,"data")
  ...
  write.csv2(catagory_sales_data, file.path(data_dir,"catagory_sales_data.csv"), , row.names = FALSE)
  ...
  #View(total_sales)
  write.csv2(total_sales, file.path(data_dir,"stores_total_sales.csv"), , row.names = FALSE)
  ...
  write.csv2(store_distribution_percentage, file.path(data_dir,"store_distribution_percentage.csv"), , row.names = FALSE)
  ...
  write.csv2(sales_attractiveness, file.path(data_dir,"sales_attractiveness.csv"), , row.names = FALSE)
}
